...
/**
 * +-----------------+-----------------------------------------+
 * |  Script         | PHProxy modify (修改版) 0.6b29          |
 * |  Author         | yourshell.info (中国)                   |
...
HEAD;
    ...
    $footer = '</ul></form><div id="footer"><a href="http://eproxy.sf.net/">PHProxy </a>modify (修改版) ' . $_version . '</div></div></body></html>';
    echo $footer;
    exit(0);
    }
